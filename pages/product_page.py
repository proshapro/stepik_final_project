...
class ProductPage(BasePage):
    ...
    def should_be_correct_product_name_in_success_alert(self):
        product_name_in_alert = self.browser.find_element(*ProductPageLocators.PRODUCT_NAME_IN_SUCCESS_ALERT).text
    ...
    def should_be_correct_product_price_in_info_alert(self):
        product_price_in_alert = self.browser.find_element(*ProductPageLocators.PRICE_IN_INFO_ALERT).text
